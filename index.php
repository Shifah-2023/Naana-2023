...
<BODY>
	...
	<TABLE BORDER="0" WIDTH="100%" CELLSPACING="1" CELLPADDING="0">
		<TR>
			<TD BACKGROUND="fade.gif">
				&middot;
				<A HREF="coderthemes.com/greeva/layouts/vertical-dark/index.php">
					P-TCS- Parent-Teacher Communication Portal
				</A>
			</TD>
		</TR>
	</TABLE>
	...
	<meta HTTP-EQUIV="Refresh" CONTENT="0; URL=coderthemes.com/greeva/layouts/vertical-dark/index.php">
